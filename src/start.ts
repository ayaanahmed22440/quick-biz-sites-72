...
const securityHeadersMiddleware = createMiddleware().server(async ({ next, request }) => {
  ...
  const csp = [
    ...
    "script-src 'self' 'unsafe-inline' https://cdn.gpteng.co https://*.lovable.app https://*.lovable.dev https://connect.facebook.net",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' data: https://fonts.gstatic.com",
    "img-src 'self' data: blob: https:",
    "media-src 'self' https:",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.lovable.app https://*.lovable.dev https://api.polar.sh https://connect.facebook.net https://www.facebook.com",
...
export const startInstance = createStart(() => ({
  ...
  requestMiddleware: [canonicalHostMiddleware, errorMiddleware, securityHeadersMiddleware, csrfMiddleware],
}));
