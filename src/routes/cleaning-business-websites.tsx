...
function CleaningBusinessLandingPage() {
  ...
  return (
    <PublicLayout>
      ...
      <section className="border-y border-border bg-muted/50 py-20 sm:py-28" data-cleaning-reveal>
        <div className="home-reveal mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[.8fr_1.2fr] lg:px-8">
      ...
      <section className="bg-background py-20 sm:py-28" data-cleaning-reveal>
        <div className="home-reveal mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
      ...
      <section className="border-y border-border bg-muted/50 py-20 sm:py-28" data-cleaning-reveal>
        <div className="home-reveal mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-[.75fr_1.25fr] lg:px-8">
      ...
      <section className="bg-background py-20 sm:py-28" data-cleaning-reveal>
        <div className="home-reveal mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="bg-navy py-20 text-navy-foreground sm:py-28" data-cleaning-reveal>
        <div className="home-reveal mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
